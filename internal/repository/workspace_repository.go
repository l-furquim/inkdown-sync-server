...
// WorkspaceRepository interface for workspace data operations
...
// CouchDBWorkspaceRepository implements WorkspaceRepository for CouchDB
type CouchDBWorkspaceRepository struct {
	db *kivik.DB
}

// workspaceDoc represents the CouchDB document structure
...
// NewWorkspaceRepository creates a new CouchDB workspace repository
...
// docToWorkspace converts a CouchDB document to a Workspace domain object
